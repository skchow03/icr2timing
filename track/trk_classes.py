...
from track.sg_classes import SGFile
import track.trk_exporter  # if you have this file too
from track.utils import approx_curve_length, sg_ground_to_trk, convert_wall_fsect_type, isclockwise
